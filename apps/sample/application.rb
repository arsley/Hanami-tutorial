...
module Sample
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['SAMPLE_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Sample::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Sample::Action is included
      ...
      # Configure the code that will yield each time Sample::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Sample::Assets::Helpers
      end
    end
